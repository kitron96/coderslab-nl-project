...
class Leave extends BaseModel
{
    ...
    public static function byUserCount($user, $year = null)
    {
        ...
        $leaveFrom = (is_null($year)) ? now(company()->timezone)->startOfYear()->toDateString() : Carbon::createFromFormat('Y', $year)->startOfYear()->toDateString();
        $leaveTo = (is_null($year)) ? now(company()->timezone)->endOfYear()->toDateString() : Carbon::createFromFormat('Y', $year)->endOfYear()->toDateString();
