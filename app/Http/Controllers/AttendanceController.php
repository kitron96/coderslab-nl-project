...
class AttendanceController extends AccountBaseController
{
    ...
    public function importStore(ImportRequest $request)
    {
        ...
        $excelData = Excel::toArray(new AttendanceImport, public_path(Files::UPLOAD_FOLDER . '/' . Files::IMPORT_FOLDER . '/' . $this->file))[0];
    ...
    public function importProcess(ImportProcessRequest $request)
    {
        ...
        $excelData = Excel::toArray(new AttendanceImport, public_path(Files::UPLOAD_FOLDER . '/' . Files::IMPORT_FOLDER . '/' . $request->file))[0];
