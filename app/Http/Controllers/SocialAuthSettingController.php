...
class SocialAuthSettingController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        $this->view = 'social-login-settings.ajax.google';

        $tab = request('tab');

        switch($tab) {
        case 'facebook':
            $this->view = 'social-login-settings.ajax.facebook';
            break;
        case 'twitter':
            $this->view = 'social-login-settings.ajax.twitter';
            break;
        case 'linkedin':
            $this->view = 'social-login-settings.ajax.linkedin';
            break;
        default:
            $this->view = 'social-login-settings.ajax.google';
            break;
    ...
    public function update(UpdateRequest $request)
    {
        ...
        session()->forget('social_auth_setting');
