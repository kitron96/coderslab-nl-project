...
jQuery(function ($) {
    ...
    if(cookieNotice) {
        ...
        gdprCookieNoticeLocales.en = {
            description: 'We gebruiken cookies op onze website om u de meest relevante ervaring te bieden door uw voorkeuren en herhaalbezoeken te onthouden. Door op "Accepteren" te klikken, stemt u in met het gebruik van ALLE cookies.',
