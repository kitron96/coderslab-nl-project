...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        foreach ($currencies as $key => $value) {
            Invoice::where('currency_id', $value->id)->update(['exchange_rate' => $value->exchange_rate]);
            Payment::where('currency_id', $value->id)->update(['exchange_rate' => $value->exchange_rate]);
            Expense::where('currency_id', $value->id)->update(['exchange_rate' => $value->exchange_rate]);
        }
