...
<div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4">
    ...
    <div class="form-group">
        ...
        @php
            $months = [
                    __("app.months.January"),
                    __("app.months.February"),
                    __('app.months.March'),
                    __('app.months.April'),
                    __('app.months.May'),
                    __('app.months.June'),
                    __('app.months.July'),
                    __('app.months.August'),
                    __('app.months.September'),
                    __('app.months.October'),
                    __('app.months.November'),
                    __('app.months.December')
              ];
        @endphp
        <div class="d-block d-lg-flex d-md-flex">
