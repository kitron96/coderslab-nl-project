                ...
                <x-table class="border-0 pb-3 admin-dash-table table-hover">
                    ...
                    @forelse($lead->follow as $key => $follow)
                        <tr id="row-{{ $follow->id }}">
                            ...
                            <td>
                                {{ $follow->created_at->timezone(company()->timezone)->format(company()->date_format . ' ' . company()->time_format) }}
                            </td>
                            <td>
                                {{ $follow->next_follow_up_date->format(company()->date_format . ' ' . company()->time_format) }}
                            </td>
                            <td>
