                    ...
                    <div class="row">
                        <div class="col-sm-12 mt-4">
                            <x-alert type="primary" icon="info-circle">
                                @lang('messages.databasebackup.info', ['time' => \Carbon\Carbon::createFromFormat('H:i:s', $backupSetting->hour_of_day)->format(company()->time_format), 'everyDayCount' => $backupSetting->backup_after_days, 'olderDayCount' => $backupSetting->delete_backup_after_days])
                            </x-alert>
                        </div>
                    </div>
                @endif
                            ...
                            <x-table class="table-bordered">
                                ...
                                @forelse ($backups as $count => $backup)
                                    <tr class="tableRow{{$count}}">
                                        ...
                                        <td>
                                            {{ \Carbon\Carbon::parse($backup['last_modified'])->timezone(company()->timezone)->format(company()->date_format . ', ' . company()->time_format) }}
                                        </td>
                                        <td class="text-right">
                                            <div class="task_view">
